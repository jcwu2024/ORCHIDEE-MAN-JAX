...
from oracle_lane_xios_ranked_send import FAMILY, PROCEDURES, SOURCE, compose, run_oracle  # noqa:E402
...
def run_coverage(output_dir=DEFAULT_OUTPUT_DIR, compiler=DEFAULT_COMPILER, gcov=GCOV):
    return run_extracted_owner_coverage(
        ...
        compiler=compiler,
        gcov=gcov,
        evidence_routes=frozenset({"output_acceptance_and_source_contract"}),
    )
