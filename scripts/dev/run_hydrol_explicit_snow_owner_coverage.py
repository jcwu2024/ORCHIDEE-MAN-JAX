...
from oracle_lane_hydrol_explicit_snow import (  # noqa: E402
    FAMILY,
    SNOW_PROCEDURES,
    SNOW_SOURCE,
    _compose,
...
PROCEDURES = set(SNOW_PROCEDURES) - {"explicitsnow_main"}
...
def run_coverage(
    ...
    return run_extracted_owner_coverage(
        ...
        compiler=compiler,
        gcov=gcov,
        condition_terminal_lines={1613: 1614},
    )


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run explicit-snow gcov owner evidence.")
