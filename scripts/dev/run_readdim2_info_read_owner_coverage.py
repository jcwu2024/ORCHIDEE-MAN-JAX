...
from oracle_lane_readdim2_info_read import (  # noqa: E402
    FAMILY,
    PROCEDURES,
    SOURCE,
    compose,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        result = run_extracted_owner_coverage(
            ...
            arm_execution_lines={
                f"{SOURCE.relative_to(ROOT).as_posix()}:583:if:true": 591,
                f"{SOURCE.relative_to(ROOT).as_posix()}:583:if:false": 593,
            },
        )
