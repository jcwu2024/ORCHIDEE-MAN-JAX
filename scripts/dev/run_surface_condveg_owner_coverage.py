...
from oracle_lane_surface_condveg import (  # noqa: E402
    FAMILY,
    SOURCE,
    _compose,
    run_oracle,
...
PROCEDURES = {"condveg_main", "condveg_z0cdrag"}
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run CONDVEG gcov owner evidence.")
