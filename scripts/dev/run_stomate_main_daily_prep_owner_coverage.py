...
from oracle_lane_stomate_main_daily_prep_owner import FAMILY, run_oracle  # noqa: E402

DEFAULT_OUTPUT_DIR = ROOT / "outputs/reference_mode/micro_oracles" / FAMILY


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run STOMATE main daily-prep owner evidence.")
