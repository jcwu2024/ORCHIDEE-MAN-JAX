...
is rejected. Its six-point 1961 production pilot passed. The formal sixth
Teacher dataset is now frozen as `pft14-daily-teacher-v6`; its first production
batch, rather than another disposable calibration, is the next operation.
Paid neural training remains deferred until enough v6 data exist.
...
drift. The active technical task is the first formal Gate E2 v6 production batch
