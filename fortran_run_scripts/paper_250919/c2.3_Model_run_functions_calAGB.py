...
def mod_extract(Igrid,d_ws,d_outloc,iterid,simid, arg1,arg2,arg3,arg4,arg5):
    ...
    #此处为没有归一化的观测数据列表
    dt_obs=pd.read_csv('/public/share/qhcess/qhcess2/User/zzhao/script/orc_cali_240430/tab_calAGB.csv')    
    ...
    dt_obs_grid.to_csv('/public/share/qhcess/qhcess2/User/zzhao/script/orc_cali_240430/modelout_calAGB/modelout_'+Igrid+'.csv')
