...
OUTPUT = ROOT / "outputs/reference_mode/micro_oracles/stomate_finalize_owner"


def test_stomate_finalize_owner_evidence_is_complete() -> None:
    ...
    assert owners["records"][0]["owner_region_id"] == "pft14-owner-contract-9bfeb74f6825"
