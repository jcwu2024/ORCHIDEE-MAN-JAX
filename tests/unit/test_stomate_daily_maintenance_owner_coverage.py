...
def test_stomate_daily_maintenance_owner_evidence_is_complete() -> None:
    output = ROOT / "outputs/reference_mode/micro_oracles/stomate_daily_maintenance"
    ...
    assert coverage["required_arm_count"] == coverage["covered_arm_count"] == 15
