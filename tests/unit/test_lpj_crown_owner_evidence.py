...
OUTPUT = ROOT / "outputs/reference_mode/micro_oracles/lpj_crown_owner"


def test_lpj_crown_owner_evidence_is_complete() -> None:
    ...
    assert len(owners["records"][0]["required_arm_ids"]) == 7
