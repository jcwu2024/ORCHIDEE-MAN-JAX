...
def test_slowproc_main_owner_evidence_is_complete() -> None:
    output = ROOT / "outputs/reference_mode/micro_oracles" / "slowproc_main_owners"
    ...
    assert coverage["required_arm_count"] == coverage["covered_arm_count"] == 48
